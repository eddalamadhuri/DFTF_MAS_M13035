		...
		<table>
			<tr>
				...
				<td><form:input type="text" path="userName" size="20"
						maxlength="20" autocomplete="off" required="true" /><font color="red"><form:errors path="userName"/></font></td>
			</tr>
			<tr>
				<td>Password:</td>
				<td><form:input type="text" path="password" required="true"/></td>
			</tr>
			<tr>
				<td>Confirm Password:</td>
				<td><form:input type="password" path="confirmpassword" required="true" /></td>
			</tr>
			<tr>
